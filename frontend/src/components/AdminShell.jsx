...
export default function AdminShell({ children }) {
  ...
  return (
    <div className="min-h-screen text-white flex overflow-hidden font-sans" style={{ background: '#0a0a0f' }}>
          ...
          >
            ...
            <div className="h-20 flex items-center px-5 shrink-0" style={{ borderBottom: '1px solid rgba(255,255,255,0.05)' }}>
              ...
              <button
                ...
                className="w-8 h-8 shrink-0 flex items-center justify-center rounded-lg cursor-pointer transition-all ml-2"
      ...
      {/* ── Main Content ── */}
      <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ease-out relative z-10 ${isSidebarOpen ? 'md:ml-72' : 'ml-0'}`}>
          ...
          <div className="flex items-center gap-2">
            <div className="relative hidden md:block">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="pl-10 pr-4 py-2.5 text-sm rounded-xl outline-none transition-all w-56"
                style={{
