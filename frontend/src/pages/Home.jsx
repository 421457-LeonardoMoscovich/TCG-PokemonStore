...
import { 
  ...
  ArrowRight, ChevronDown, Shield, Truck, Award,
  Package, RotateCcw, Globe, Lock
} from 'lucide-react';
...
>
  <div
    className="w-full px-6 md:px-12 max-w-[1600px] mx-auto"
    style={{
      maxWidth: '1720px',
      paddingLeft: '28px',
      paddingRight: '28px'
  ...
  >
    ...
    >
      <span
        className="text-xs font-semibold uppercase tracking-[0.2em] mb-3 block text-primary"
        style={{
          display: 'block',
          marginBottom: '18px'
        }}
    ...
    <div
      className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 lg:grid-cols-5"
      style={{
        rowGap: '30px',
        columnGap: '28px',
        paddingTop: '10px',
  ...
  className="flex items-center rounded-md relative overflow-hidden group bg-bg-elevated border border-white/5 transition-colors hover:border-white/10"
  style={{
    minHeight: '72px',
    paddingLeft: '18px',
    paddingRight: '20px',
...
>
          ...
          />
          <div
            className="relative w-10 h-10 rounded-lg flex items-center justify-center pointer-events-none"
            style={{ background: `${color}33` }}
          >
            <Icon className="w-5 h-5 md:w-6 md:h-6" style={{ color }} />
          </div>
          <span className="relative text-sm md:text-base font-bold text-gray-300 group-hover:text-white transition-colors">
            {label}
          </span>
        </motion.button>
      ))}
...
>
  ...
  >
      ...
      {loading ? (
        ...
        >
          {[1, 2, 3, 4, 5, 6].map(i => (
            <div
              key={i}
              className="w-44 md:w-52 aspect-[3/4] rounded-md animate-pulse shrink-0 bg-bg-elevated"
            />
          ))}
        </div>
        ...
        >
          {[...featuredCards, ...featuredCards].map((carta, i) => (
            ...
            >
              ...
              >
                <div
                  className="aspect-[3/4] overflow-hidden bg-bg-surface relative"
                  style={{
                    marginBottom: '0px'
                  }}
                >
                ...
                >
                  ...
                  >
                    <span className="text-[10px] px-3 py-1 rounded-md font-bold bg-primary/10 text-primary">
                      {carta.type}
                    </span>
                    {carta.price && (
    ...
    <section
  className="bg-bg-surface relative overflow-hidden border-t border-white/5 flex flex-col justify-center items-center"
  style={{
    marginTop: '64px',
    paddingTop: '80px',
    paddingBottom: '80px'
...
>
  <div
    className="w-full px-6 md:px-12 max-w-7xl mx-auto relative z-10 flex flex-col items-center"
    style={{
      maxWidth: '1280px',
      paddingLeft: '28px',
      paddingRight: '28px'
  ...
  >
    ...
    >
      <span
        className="text-xs font-semibold uppercase tracking-[0.2em] block text-primary"
    ...
    {/* Grid */}
    <div
      className="w-full grid grid-cols-1 md:grid-cols-3 md:grid-rows-2"
      style={{
        columnGap: '24px',
        rowGap: '24px'
      }}
    >
      ...
      <motion.div
        ...
        viewport={{ once: true }}
        transition={{ delay: 0.1 }}
        className="w-full md:col-span-2 md:row-span-2 relative rounded-md group glass-card border border-white/5 overflow-hidden flex flex-col"
        style={{
          padding: '30px',
          minHeight: '380px',
          background:
            'linear-gradient(145deg, rgba(20,20,20,0.92) 0%, rgba(10,10,10,1) 100%)'
        }}
      >
        ...
        >
          <span className="text-5xl md:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-500">
            100%
          </span>
          <span
            style={{
      ...
      <motion.div
        ...
        className="w-full relative rounded-md glass-card border border-white/5 flex flex-col justify-between"
        style={{
          padding: '24px',
          minHeight: '200px'
        }}
      >
        <div>
          ...
          <h3 style={{ marginBottom: '10px' }} className="text-white font-bold">
            Curación Experta
          </h3>

          <p className="text-gray-400 text-sm">
            Especialistas seleccionan cada unidad evaluando calidad real.
          </p>
        </div>
      ...
      >
        <div>
          ...
          <p className="text-gray-400 text-sm">
            Transporte seguro y controlado de extremo a extremo.
          </p>
        </div>

        <div style={{ marginTop: '20px' }}>
          <span className="text-3xl font-black text-primary">48HS</span>
        </div>
      </motion.div>
    </div>
  </div>
      ...
      {/* Trust Bar */}
      <section
  className="border-y border-white/5 bg-bg-base"
  style={{
    paddingTop: '72px',
    paddingBottom: '72px',
    marginTop: '72px'
  ...
  >
    ...
    >
      {[
        ...
        >
          <div
            className="rounded-lg flex items-center justify-center shrink-0 bg-bg-elevated border border-white/5 group-hover:border-primary/30 transition-colors"
            style={{
              width: '50px',
              height: '50px'
            }}
